...
#define PIN_BUTTON_B2   26          // B2 / B / A / Circle / 3 / K2
#define PIN_BUTTON_R2   27          // R2 / RT / ZR / R2 / 8 / K3
...
#define PIN_TILT_LEFT_ANALOG_DOWN 3 
#define PIN_TILT_LEFT_ANALOG_LEFT 4 
#define PIN_TILT_LEFT_ANALOG_RIGHT 2
#define PIN_TILT_RIGHT_ANALOG_UP 12
#define PIN_TILT_RIGHT_ANALOG_DOWN 15
#define PIN_TILT_RIGHT_ANALOG_LEFT 13
#define PIN_TILT_RIGHT_ANALOG_RIGHT 16
